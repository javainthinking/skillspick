...
export default function SkillCard({
  ...
  return (
    ...
    >
      <div className="text-lg font-semibold leading-snug text-white transition group-hover:text-white">{s.name}</div>
      ...
      <div className="mt-3 line-clamp-2 text-base leading-relaxed text-white/60">{s.description || ""}</div>
